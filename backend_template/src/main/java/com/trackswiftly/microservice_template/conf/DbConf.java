package com.trackswiftly.microservice_template.conf;
...
import com.trackswiftly.microservice_template.utils.PropertiesLoader;
...
public class DbConf {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("propertiesLoader1") PropertiesLoader propertiesLoader) {
        ...
        emf.setPackagesToScan("com.trackswiftly.microservice_template.entities");
